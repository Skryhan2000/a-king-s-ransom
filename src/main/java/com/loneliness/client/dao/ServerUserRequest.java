...
public class ServerUserRequest implements CRUD{
    @Override
    public boolean create(UserData user) throws IOException, ClassNotFoundException {
    ...
    @Override
    public UserData read(UserData user) throws IOException, ClassNotFoundException {
        Transmission transmission = new Transmission();
    ...
    @Override
    public boolean update(UserData user) throws IOException, ClassNotFoundException {
        Transmission transmission = new Transmission();
    ...
    @Override
    public boolean delete(UserData user) throws IOException, ClassNotFoundException {
        Transmission transmission = new Transmission();
    ...
    public String authorize(UserData userData) throws IOException, ClassNotFoundException {
        Transmission transmission = new Transmission();
   ...
   @Override
    public ConcurrentHashMap receiveAll() throws IOException, ClassNotFoundException {
       Transmission transmission = new Transmission();
