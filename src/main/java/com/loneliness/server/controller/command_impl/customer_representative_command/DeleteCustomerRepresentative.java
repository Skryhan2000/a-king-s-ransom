...
public class DeleteCustomerRepresentative implements Command<CustomerRepresentative,String> {
    @Override
    public String execute(CustomerRepresentative request) {
        return ServiceFactory.getInstance().getCustomerRepresentativeService().delete(request);
    }
}
