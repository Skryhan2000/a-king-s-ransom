...
public class CreateCustomerRepresentative implements Command<CustomerRepresentative,String> {
    @Override
    public String execute(CustomerRepresentative request) {
        return ServiceFactory.getInstance().getCustomerRepresentativeService().create(request);
    }
}
