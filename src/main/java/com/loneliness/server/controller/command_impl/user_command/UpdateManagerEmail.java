...
public class UpdateManagerEmail implements Command<Map<Integer,String>,String> {
    @Override
    public String execute(Map<Integer, String> request)  {
        return ServiceFactory.getInstance().getUserService().updateManagerEmail(request);
    }
}
