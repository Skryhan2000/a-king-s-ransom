...
public enum  CommandName {
     ...
     AUTHORIZATION_USER, CREATE_USER, DELETE_USER, RECEIVE_USER, RECEIVE_ALL_USERS, UPDATE_USER, SHUT_DOWN,
     FIND_USERS_BY_LOGIN_AND_TYPE, RECEIVE_ALL_USERS_IN_LIMIT, UPDATE_MANAGER_EMAIL, READ_MANAGER_EMAIL,
     DELETE_MANAGER_EMAIL, ADD_MANAGER_EMAIL,
     ...
     CREATE_PRODUCT,  RECEIVE_PRODUCT_GOODS,

     CREATE_CUSTOMER_REPRESENTATIVE, DELETE_CUSTOMER_REPRESENTATIVE, RECEIVE_ALL_CUSTOMER_REPRESENTATIVES,
     RECEIVE_ALL_CUSTOMER_REPRESENTATIVES_IN_LIMIT, RECEIVE_CUSTOMER_REPRESENTATIVE_DATA,
     UPDATE_CUSTOMER_REPRESENTATIVE
}
